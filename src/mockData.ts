...
export const mockAIFindings: AIFinding[] = [
  {
    ...
    title: "Potential N+1 Query in OrderController Iteration",
    category: "Performance",
    severity: "Medium",
    confidence: 86,
    affectedFile: "OrderController.php:48",
    evidence: "Query detected inside foreach loop over $orders without eager loading ->items relationship.",
    impact: "Causes 100+ separate SQL trips when serializing POS daily checkout summary.",
    suggestedRemediation: "Utilize User::with(['orders.items'])->get() to batch hydrate relations in single SQL query.",
    status: "PENDING",
